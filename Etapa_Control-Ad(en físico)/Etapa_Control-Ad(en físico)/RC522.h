//conexión de modulo RFID usando SPI por software
...
{
        MFRC522_CS = 0;
        Soft_SPI_Write( ( addr << 1 ) & 0x7E );          // 0 bbb bbb 0     ---> bit 7: escritura; bit 0: siempre es 0
...
static char MFRC522_Rd( char addr )
{
        char value;
        MFRC522_CS = 0;
        Soft_SPI_Write( (( addr << 1 ) & 0x7E) | 0x80 );  // 1 bbb bbb 0     ---> bit 7: lectura; bit 0: siempre es 0
